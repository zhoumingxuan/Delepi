...
flowchart TD
  ...
  E --> F[尽最大努力进行【研究探索】，获取【完全不耦合】的【备选研究方向】，并更新到【备选研究方向集合】]
  F --> F1[复核所有【备选研究方向】，排除无法完成【设计目标】的【备选研究方向】，并更新【备选研究方向集合】]
  F1 --> F2[尽最大努力去全面查找【备选研究方向】的【可行性、可实施路径】，记录到【研究笔记】中。]
  F2 --> G[调用可用工具，按照【研究方向分析规则】对每个【备选研究方向】进行【深度和全面】的交叉分析]
  G --> H[]
  G --> I[调用可用工具，分析每个【备选方案】的核心思路【专业性优点、专业性缺点】，并获取【最权威、最新】证据进行证明]
  I --> J[依据当前所有已知事实，形成【方案文档】的【最初版本】]
  ...
  N -- 是 --> O[生成假设性【结论X】:当前【方案】是所有已知信息中【设计最简洁、最精妙、方法最可靠、副作用最低、交互最优秀】]
...
### 关键定义和说明（**必须严格遵守**）
 ...
 5. 【常规方案】：依据最新、最权威、最专业的资料，设计并能够实现目标方案；通常是已明确尝试过，并且验证的可行方案；**注意：常规方案虽可行，却必然存在缺点，故此未必一定适配当前环境**。
 6. 【非常规方案】：是指不采用当前资料已知的可行方式，使用很难思考到、比较另类、却简洁有效的思路设计而成的方案；尽量使用【创造性思路】，可不受任何限制进行穷举，只要能达成设计目标。
...
### 附加输出要求(**必须严格遵守**)
 ...
 2. 输出必须包含方案设计的过程中，【备选方案集合】的从创建到筛选整个过程。
 3. 输出必须包含方案设计的过程中，已发现的所有【隐含信息】和【难点和痛点】。
 4. 输出必须包含方案设计的过程中，分析出的【隐含要求】和【时效性要求】。
 5. 输出必须包含方案每次迭代过程中，方案按【方案收敛规则】进行【逐步、逐项收敛】的完整过程。
 6. 输出必须包含【方案文档】中可解决的具体【难点和痛点】的方法介绍。
 7. 输出必须包含【方案文档】的【优点】、【缺点】以及【风险点】介绍。
 8. 输出必须包含【方案文档】的设计是【设计最简洁、最精妙、方法最可靠、副作用最低、交互最优秀】的证明过程。
