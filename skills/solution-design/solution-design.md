...
flowchart TD
  ...
  F2 --> G[开始用正确的方式，尽最大努力论证每个【研究方向】【可行性、可实施性】的具体条件]
  G --> G1[排除不具备【可行性、可实施性】的【研究方向】，并更新【备选研究方向集合】]
  G --> H{判断【备选研究方向集合】中【研究方向】数量是否小于3}
  H -- 是 --> F
  H -- 否 --> I[调用可用工具，分析所有剩余的每个【研究方向】的【优点、缺点、风险点、专业点、精妙点、复杂点、重复点等】]
...
### 附加输出要求(**必须严格遵守**)
 ...
 9. 输出必须包含【方案文档】的设计是【设计最简洁、最精妙、方法最可靠、副作用最低、交互最优秀】的证明过程。