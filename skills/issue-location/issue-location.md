...
flowchart TD
  ...
  F1 --> G[尽力最大努力全量查找与【未证实的触发场景】有关的，【不成立】或者【不可能发生】的【证据链】]
  ...
  M1 --> N{判断【未证实的根因集合】，只能解释一个或部分【错误现象】}
  N -- 是 --> M
  N -- 否 --> O[生成一个【假设性】结论X:剩余的【未证实根因】就是产生当前问题的【根因】]
  O --> P[使用【最正确】的方式，尽最大努力全面查找【可推翻】结论X的【证据链】]
  P --> P1[为避免遗漏，再次尽最大努力全面查找【可推翻】结论X的【证据链】]
  P1 --> Q{判断是否存在【可推翻】结论X的【证据链】}
  Q -- 是 --> R[将分析过程记录到【诊断日志】中，尽最大努力尝试挖掘更多【显示/隐式/细微/极难发现】的【可继续调研线索】]
  R --> M
